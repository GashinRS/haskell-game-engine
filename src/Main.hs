...
import qualified Tanks (tanksMain, gamePic, move, next, startGame)
...
gamePic (Frogger p c t r) = Frogger.gamePic $ Frogger p c t r
...
move e (Frogger p c t r)                                    = Frogger.move e $ Frogger p c t r
...
next x (Frogger p c t r) = Frogger.next x $ Frogger p c t r
